...
export function StoreLocatorPage() {
  ...
  return (
    <div className="min-h-screen bg-[#dff1ff] px-4 py-6 text-[#1a1a1a]">
      <div className="mx-auto flex h-[calc(100vh-3rem)] max-w-screen-2xl flex-col gap-6 lg:flex-row">
        <div className="relative z-10 w-full max-w-xl rounded-[32px] bg-white shadow-2xl ring-1 ring-black/5">
          <header className="flex items-center justify-between border-b px-8 py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-2xl font-semibold">Selecciona una tienda para recoger</p>
              ...
              {stores.map((store) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <RadioGroupItem id={store.id} value={store.id} className="mt-1" />
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center justify-between">
                        <Label htmlFor={store.id} className="text-lg font-semibold text-[#1d1d1f]">
                          {store.name}
                        </Label>
                      ...
                      <p className="text-sm leading-relaxed text-[#535353]">{store.address}</p>
                      <p className="text-sm font-medium text-[#1d1d1f]">{store.hours}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="border-t px-8 py-6">
            <div className="mb-4 rounded-2xl bg-[#fff5f6] px-4 py-3 text-sm text-[#dc1b2e]">
              Estas a {selectedStore.distance}. Recoge hoy mismo en{" "}
